...
static const uint8_t __attribute__((unused))char_prop_notify = ESP_GATT_CHAR_PROP_BIT_NOTIFY;
...
static const uint8_t __attribute__((unused))char_prop_read_write_notify =ESP_GATT_CHAR_PROP_BIT_READ |ESP_GATT_CHAR_PROP_BIT_WRITE |ESP_GATT_CHAR_PROP_BIT_NOTIFY;
